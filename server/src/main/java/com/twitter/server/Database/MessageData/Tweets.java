package com.twitter.server.Database.MessageData;
...
import com.twitter.server.Database.Insertable;
import com.twitter.server.Database.Table;
import com.twitter.server.Database.UserData.Followers;
import com.twitter.server.Database.UserData.Users;
import com.twitter.server.Utils.DBUtils;
...
public class Tweets extends Table implements Insertable<Tweet> { //TODO: this class needs further investigation for improving code quality
    ...
    public synchronized List<Tweet> selectTimelineTweets(int userId, int MAX_COUNT) {
        try(PreparedStatement pStmt = conn.prepareStatement(
                    ...
                    + Users.TABLE_NAME + "." + Users.COL_PROFILE_PIC_PATH + ", "
                    + TABLE_NAME + "." + COL_TEXT + ", "
    ...
    public synchronized List<Retweet> selectTimelineRetweets(int userId, int MAX_COUNT) {
        ...
        try(PreparedStatement pStmt = conn.prepareStatement(
                ...
                + USERS_TABLE_ALIAS_OS + "." + Users.COL_PROFILE_PIC_PATH + ", "
    ...
    private String mentionQuoteHelper(
        ...
        return "SELECT " +
                ...
                users_alias_original + "." + Users.COL_PROFILE_PIC_PATH + " AS original_profile_pic, " +
                ...
                "original_sender" + "." + Users.COL_PROFILE_PIC_PATH + " AS " + person + "_profile_pic, " +
